...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen relative font-sans overflow-x-hidden">
      {/* Global Persistent Fullscreen Toggle - Optimized for mobile corners */}
      <motion.button 
        initial={{ opacity: 0, scale: 0.8 }}
        animate={{ opacity: 1, scale: 1 }}
        onClick={toggleFullscreen}
        className="fixed top-4 right-4 md:top-10 md:right-10 z-[100] p-4 md:p-6 glass-panel rounded-full md:rounded-[24px] shadow-2xl hover:scale-110 active:scale-95 transition-all text-morandi-forest/60 hover:text-morandi-forest border-white/40"
